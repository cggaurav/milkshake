...
// var peer = new Peer('spotifywinamp', {key: 'aym5yww9qojsv2t9'});

// peer.on('open', function(id) {
//   console.log('My peer ID inside Spotify is: ' + id);
// });
...
var milk = (function(){
    ...
    var SoundCloudAudio = Class.extend({
    	...
    	init: function () {
    	    ...
    	    this.playlistURL = "http://soundcloud.com/cggaurav/favorites";
    	    var args = window.location.search.substring(1).split("&");
    	    for (var i = 0; i < args.length; i++) {
    		var arg = args[i].split("=");
    		if (arg[0] == "tracks") {
    		    this.playlistURL = unescape(arg[1]);
    		    console.log(this.playlistURL, 'X');
    		    break;
    		}
    	    }
